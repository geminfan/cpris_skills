...
1. **民营机构解决方案**：为民营机构打造智慧康复平台，有效提升机构教师工作效率
2. **医疗科室解决方案**：独立部署解决安全问题，增强医院规范化一体化康复管理
3. **主管单位解决方案**：全流程管控机构与医院特殊儿童康复训练及费用使用情况
4. **家长解决方案**：为特殊儿童的父母提供心理赋能和知识技术赋能

### 技术架构

本 Skill 对接的是希普在线微信小程序后端 REST API，基于 STRATO sboot 框架（OSGi + Velocity + MyBatis）构建，采用网关统一接入、Token 认证、模块化服务的架构设计。
