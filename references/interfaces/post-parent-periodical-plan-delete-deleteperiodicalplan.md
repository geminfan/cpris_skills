# POST /parent/periodical/plan/delete

## 定位

- 模块：`parent`
- Controller：`ParentPeriodicalController`
- 源码：`C:\work\javacode\cpris_wxapp\parent\src\main\java\com\cpris\controller\ParentPeriodicalController.java:403`
