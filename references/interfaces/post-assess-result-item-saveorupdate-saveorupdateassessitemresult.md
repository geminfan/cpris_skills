...
- 源码：`cpris_wxapp/assess/src/main/java/com/cpris/controller/AssessController.java:456`
...
- JSON 请求体：`@RequestBody AssessResultValueItemContent assessResultValueItemContent`
