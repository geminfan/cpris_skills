# POST /assess/result/saveOrUpdate

## 定位

- 模块：`assess`
- Controller：`AssessController`
- 源码：`cpris_wxapp/assess/src/main/java/com/cpris/controller/AssessController.java:188`
...
`assessResultValueService.save`、`assessResultValueService.updateById`、`assessResultValueService.saveOrUpdate`
