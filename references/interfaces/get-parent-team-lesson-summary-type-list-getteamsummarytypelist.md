# GET /parent/team/lesson/summary/type/list

## 定位

- 模块：`parent`
- Controller：`ParentTeamController`
- 源码：`C:\work\javacode\cpris_wxapp\parent\src\main\java\com\cpris\controller\ParentTeamController.java:152`
...
- HTTP 方法：`GET`
- 路径：`/parent/team/lesson/summary/type/list`
