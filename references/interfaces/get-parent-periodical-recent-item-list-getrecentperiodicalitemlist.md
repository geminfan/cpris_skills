# GET /parent/periodical/recent/item/List

## 定位

- 模块：`parent`
- Controller：`ParentPeriodicalController`
- 源码：`C:\work\javacode\cpris_wxapp\parent\src\main\java\com\cpris\controller\ParentPeriodicalController.java:225`
...
- HTTP 方法：`GET`
- 路径：`/parent/periodical/recent/item/List`
...
- 请求参数：`(value = "康复指导文本模糊查询"`
- Query 参数：`example = "") String content`
