...
- 源码：`cpris_wxapp/training/src/main/java/com/cpris/controller/IepLibController.java:160`
...
- JSON 请求体：`@RequestBody List<TRecoverPplandetailTeacherPref> iepLibList`
