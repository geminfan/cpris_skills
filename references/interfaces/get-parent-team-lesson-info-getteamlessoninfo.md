...
- 源码：`cpris_wxapp/parent/src/main/java/com/cpris/controller/ParentTeamController.java:109`
...
- Query/表单：`@ApiParam(value = "组训课程id", required = true) @RequestParam String scheduleDefineId`
