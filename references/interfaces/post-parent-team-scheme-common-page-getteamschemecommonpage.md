# POST /parent/team/scheme/common/page

## 定位

- 模块：`parent`
- Controller：`ParentTeamController`
- 源码：`C:\work\javacode\cpris_wxapp\parent\src\main\java\com\cpris\controller\ParentTeamController.java:250`
...
- HTTP 方法：`POST`
- 路径：`/parent/team/scheme/common/page`
