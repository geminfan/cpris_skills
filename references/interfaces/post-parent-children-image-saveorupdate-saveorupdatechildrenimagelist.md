# POST /parent/children/image/saveOrUpdate

## 定位

- 模块：`parent`
- Controller：`ParentChildrenController`
- 源码：`cpris_wxapp/parent/src/main/java/com/cpris/controller/ParentChildrenController.java:231`
...
- HTTP 方法：`POST`
- 路径：`/parent/children/image/saveOrUpdate`
...
- JSON 请求体：`@ApiParam(value = "儿童的图片列表", required = true) @RequestBody List<TChildrenImage> childrenImageList`
