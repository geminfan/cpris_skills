# GET /parent/assess/result/info

## 定位

- 模块：`parent`
- Controller：`ParentAssessController`
- 源码：`cpris_wxapp/parent/src/main/java/com/cpris/controller/ParentAssessController.java:52`
...
- Query/表单：`@ApiParam(value = "评估id", required = true) @RequestParam String assessId`
- Query/表单：`@ApiParam(value = "评估定义问卷id", required = true) @RequestParam String assessDefinePaperId`
