...
- 源码：`C:\work\javacode\cpris_wxapp\assess\src\main\java\com\cpris\controller\AssessController.java:207`
- Java 方法：`finishAssess`
...
- HTTP 方法：`POST`
- 路径：`/assess/finish`
- 方法签名：`R<String> finishAssess(@RequestParam String assessId)`
