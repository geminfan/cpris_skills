# GET /parent/periodical/record/type/list

## 定位

- 模块：`parent`
- Controller：`ParentPeriodicalController`
- 源码：`C:\work\javacode\cpris_wxapp\parent\src\main\java\com\cpris\controller\ParentPeriodicalController.java:127`
...
- HTTP 方法：`GET`
- 路径：`/parent/periodical/record/type/list`
