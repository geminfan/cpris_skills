# POST /iepLib/myIep/page

## 定位

- 模块：`training`
- Controller：`IepLibController`
- 源码：`cpris_wxapp/training/src/main/java/com/cpris/controller/IepLibController.java:38`
- Java 方法：`getMyIepLibPage`
...
- HTTP 方法：`POST`
- 路径：`/iepLib/myIep/page`
- 方法签名：`R<Page<TRecoverPplandetailTeacherPref>> getMyIepLibPage(@ApiParam(value = "页码", example = "1") @RequestParam(defaultValue = "1") long current, @RequestBody IepDetailVo iepDetailVo)`
